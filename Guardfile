...
guard 'livereload' do
  ...
  watch(%r{(app|vendor)(/assets/\w+/(.+\.(css|scss|sass|js|coffee|em|emblem|html|png|jpg))).*}) { |m| "/assets/#{m[3]}" }
  watch(%r{(frontend)(/\w+/(.+\.(css|scss|sass|js|coffee|em|emblem|html|png|jpg)))$}) { |m| "/frontend#{m[2]}" }
end
